...
- [ ] **F4-TICKETCFG-01** — Los seis logotipos de fábrica y el contrato en `shared`
...
- [ ] **F4-TICKETCFG-02** — Migración `ticket_settings` + RLS
...
- [ ] **F4-TICKETCFG-03** — El procesador de logotipos: `sharp` en el API
...
- [ ] **F4-TICKETCFG-04** — `TicketSettingsService` y sus endpoints
...
- [ ] **F4-TICKETCFG-05** — El ticket de venta y la cotización obedecen la configuración
...
- [ ] **F4-TICKETCFG-07** — La orden médica en carta respeta nombre, dirección y teléfono
...
- [ ] **F4-TICKETCFG-09** — QA en el navegador y en papel
