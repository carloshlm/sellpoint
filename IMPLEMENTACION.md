...
- [x] **F4-CART-01** — El strategy de lookups, filtrado por el almacén del turno
  ...
  - **Corregido al construir (2026-08-22):** el respaldo contra `products.barcode` "legacy" **no se implementó porque esa columna nunca existió** — el código de barras nació en la presentación con F2-PRESENT y ahí se quedó. Un catálogo con códigos alfanuméricos igual se encuentra: cae en `TextSearchLookup`, que también mira `barcode`
