...
- [ ] **F9-CLINIC-HC-01** — El catálogo reestructurado: 26 claves, orden nuevo, herencia y sexo en la definición
...
- [ ] **F9-CLINIC-HC-02** — La aritmética clínica en shared: IMC, índice tabáquico, FPP y semáforo
...
- [ ] **F9-CLINIC-HC-03** — `NumberField`: un número con su unidad
...
- [ ] **F9-CLINIC-HC-04** — Tres primitivas: la lista de filas, el «Negados» y el checklist de hallazgos
...
- [ ] **F9-CLINIC-HC-05** — Los antecedentes se heredan de la consulta anterior
...
- [ ] **F9-CLINIC-HC-07** — Antecedentes Personales Patológicos: seis bloques con listas
...
- [ ] **F9-CLINIC-HC-08** — Antecedentes Personales No Patológicos: hábitos, vivienda e índice tabáquico
...
- [ ] **F9-CLINIC-HC-09** — Antecedentes Gineco-Obstétricos: G/P/A/C y la FPP calculada
...
- [ ] **F9-CLINIC-HC-10** — Alergias: negadas o una lista con gravedad
...
- [ ] **F9-CLINIC-HC-11** — Medicamentos Actuales: ninguno o una lista
...
- [ ] **F9-CLINIC-HC-12** — Interrogatorio por Aparatos y Sistemas: todo negado en un clic
...
- [ ] **F9-CLINIC-HC-13** — Lo que la NOM pide en Datos Generales, las alergias en el encabezado y AGO por sexo
...
- [ ] **F9-CLINIC-HC-14** — Somatometría: peso, talla y el IMC que se calcula solo
...
- [ ] **F9-CLINIC-HC-16** — Exploración Física por regiones: «Todo sin alteraciones» y solo escribir el hallazgo
...
- [ ] **F9-CLINIC-HC-17** — Resultados de Estudios: previos y actuales, en una lista
...
- [ ] **F9-CLINIC-HC-18** — Impresión Diagnóstica y Diagnósticos: una lista con CIE-10 a mano
...
- [ ] **F9-CLINIC-HC-19** — Tratamiento: la indicación terapéutica, con la receta a un clic
...
- [ ] **F9-CLINIC-HC-21** — Seguimiento y Recomendaciones: la próxima cita y los datos de alarma
...
- [ ] **F9-CLINIC-HC-22** — El catálogo CIE-10 global y su buscador
...
- [ ] **F9-CLINIC-HC-23** — El picker CIE-10 en Diagnósticos
...
- [ ] **F9-CLINIC-HC-24** — e2e del API: las 16 secciones nuevas contra sus schemas
...
- [ ] **F9-CLINIC-HC-25** — QA en el navegador, documentos vivos y cierre
