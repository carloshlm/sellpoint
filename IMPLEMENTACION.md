...
- [ ] **F9-CLINIC-25** *(agregada el 2026-09-03: continuar la consulta abierta y vencimiento por día)* — La regla del candado del expediente en `shared`
...
- [ ] **F9-CLINIC-26** — El API obedece el candado: `editable`, `lockReason` y 409 `record_expired`
...
- [ ] **F9-CLINIC-27** — Alta sin duplicar y búsqueda que sabe si se puede continuar
...
- [ ] **F9-CLINIC-28** — e2e del ciclo «continuar hoy, vencer mañana»
...
- [ ] **F9-CLINIC-WEB-23** *(agregada el 2026-09-03: continuar la consulta abierta y vencimiento por día)* — «Continuar consulta» desde la búsqueda, sin abrir otro folio
...
- [ ] **F9-CLINIC-WEB-24** — Vencida en pantalla: pill, aviso y «Nueva consulta»
...
- [ ] **F9-CLINIC-WEB-25** — QA del ciclo y cierre
