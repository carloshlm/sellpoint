...
| **F1** | Multi-Tenant + Auth | ✅ Completada (F1-NAME cerrado el 2026-09-06) · ⬜ F1-ADDR pendiente | 2-3 semanas + NAME ~23 h + ADDR ~18 h | ✅ Sí (2026-09-06: F1-NAME, 11 tareas · 2026-09-08: F1-ADDR, 9 tareas) |
...
- [ ] **F1-ADDR-01** — Factory `buildWarehouse` para los tests del web
...
- [ ] **F1-ADDR-02** — `address.ts`: los formatos, las 32 regiones de México y `formatAddress`
...
- [ ] **F1-ADDR-03** — Migración aditiva, DTOs y la trampa de la región mexicana
...
- [ ] **F1-ADDR-04** — `AddressFields`: un solo componente para el wizard, Mi perfil y los almacenes
...
- [ ] **F1-ADDR-05** — El paso 1 del wizard pide la dirección completa, y un solo select de región
...
- [ ] **F1-ADDR-06** — Mi perfil: se completa sin obligar, y la región fiscal tiene un solo dueño
...
- [ ] **F1-ADDR-07** — El ticket y el PDF imprimen la dirección en el orden de su país
...
- [ ] **F1-ADDR-08** — Almacenes: el formulario, la tabla y el Excel de ida y vuelta
...
- [ ] **F1-ADDR-09** — `MERCADOS.md` §4 y los documentos vivos
