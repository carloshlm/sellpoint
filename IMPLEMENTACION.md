...
- [ ] **F7-LIFECYCLE-01** — El contrato del ciclo de vida en `shared`
...
- [ ] **F7-LIFECYCLE-02** — Migración: estado en `tenants` + `purge_tenant()` en Postgres
...
- [ ] **F7-LIFECYCLE-03** — `POST /admin/tenants/:id/suspend` y `/reactivate`
...
- [ ] **F7-LIFECYCLE-04** — Un negocio desactivado no entra: login y refresh
...
- [ ] **F7-LIFECYCLE-05** — `DELETE /admin/tenants/:id`: los tres candados y la purga
...
- [ ] **F7-LIFECYCLE-06** — e2e del ciclo completo
...
- [ ] **F7-LIFECYCLE-07** — Cliente web y la lista de Negocios
...
- [ ] **F7-LIFECYCLE-08** — «Zona de peligro» en el detalle del negocio
...
- [ ] **F7-LIFECYCLE-09** — QA en sandbox y cierre
