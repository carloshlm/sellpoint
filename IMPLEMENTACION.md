...
- [ ] **F1-NAME-04** — El `pull` antes de la migración
...
- [ ] **F1-NAME-05** — La migración escrita a mano y el modelo
...
- [ ] **F1-NAME-06** — El rename en el API
...
- [ ] **F1-NAME-07** — El rename en el web
