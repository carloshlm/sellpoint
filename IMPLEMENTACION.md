...
- [ ] **F3-SVC-01** — Modelo `Service` + migración con RLS de nacimiento
...
- [ ] **F3-SVC-02** — Permisos `services:read` / `services:manage`
...
- [ ] **F3-SVC-03** — API CRUD de servicios
...
- [ ] **F3-SVC-04** — UI: listado, form y entrada en el menú
...
- [ ] **F3-SVC-05** — Sincronizar las fuentes de verdad + coherencia F4
