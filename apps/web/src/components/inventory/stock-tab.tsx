      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b text-left text-muted-foreground">
            ...
            <th className="py-2 font-medium">{t("inventory.kardex.stockUpdated")}</th>
          </tr>
        </thead>
        <tbody>
          {data.rows.map((row) => (
        ...
        <tfoot>
          <tr className="border-t font-medium">
            <td className="py-2">{t("inventory.kardex.stockTotal")}</td>
            <td className="py-2">
              {data.total} {unidad}
              {data.belowMin && (
                <Badge
          ...
          {enTransito !== undefined && (
            <tr data-testid="in-transit" className="text-muted-foreground">
              <td className="py-2" title={t("inventory.kardex.inTransitHint")}>
