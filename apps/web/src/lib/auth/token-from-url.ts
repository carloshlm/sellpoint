 ...
 * así que el 22 ya no quedaba ninguno vivo — la verificación (24 h) y el reset
 * (30 min) habían vencido mucho antes. La deuda nació con fecha justamente
 * para que retirarla fuera una cuenta y no una discusión.
 *
