...
/**
 * F9-CLINIC-07 — el catálogo de estudios de laboratorio. `@RequiresModule("medical_clinic")` a nivel de CLASE: sin el módulo,
 * el controller entero responde 402, también las lecturas. `:read` mira,
 * `:manage` administra.
 */
@ApiTags("medical-clinic")
@RequiresModule("medical_clinic")
@Controller("medical-clinic/lab-studies")
export class MedicalClinicLabStudiesController {
  constructor(
    private readonly studies: LabStudiesService,
    private readonly importService: LabStudyImportService,
  ) {}
