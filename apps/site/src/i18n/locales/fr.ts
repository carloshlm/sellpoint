...
export const fr: Messages = {
  ...
  inAction: {
    eyebrow: "À votre comptoir",
    title: "Scannez, encaissez et remettez le reçu.",
    sub: "Voici une vente avec SellPointy\u00a0: vous passez le produit devant le lecteur, il s'affiche à l'écran avec son prix et vous encaissez. Aucun prix à taper, aucune liste à parcourir.",
    steps: {
      scan: { title: "Scannez", text: "Le produit s'ajoute à la vente avec son nom et son prix." },
      charge: {
        title: "Encaissez",
        text: "Le total se calcule tout seul. Il ne vous reste qu'à confirmer.",
      },
      ticket: { title: "Remettez le reçu", text: "À votre logo, prêt pour votre client." },
    },
    imageAlt:
  ...
  insights: {
    ...
    title: "Ouvrez SellPointy et voyez où en est votre journée.",
    sub: "Ventes, bénéfice et transactions en temps réel, depuis la caisse ou depuis votre téléphone. Sans attendre la fermeture et sans préparer de rapport.",
    points: [
      "Vos ventes du jour et du mois, par rapport à votre objectif.",
      "Votre bénéfice\u00a0: ce que vous avez vendu moins ce que cela vous a coûté.",
      "Vos meilleures ventes et les heures où vous vendez le plus.",
    ],
    note: "Inclus dans tous les forfaits.",
    mock: {
      label: "Exemple du tableau de bord de SellPointy avec les ventes du jour et du mois",
      badge: "En direct",
      title: "Tableau de bord",
      tabs: { today: "Aujourd'hui", week: "Cette semaine", month: "Ce mois-ci" },
      today: "Ventes du jour",
      month: "Ventes du mois",
      goal: "{percent}\u00a0% de l'objectif",
      profit: "Bénéfice du mois",
      tickets: "Transactions du jour",
      average: "{amount} en moyenne",
      trend: "Ventes\u00a0: ce mois-ci et le mois dernier",
      current: "Ce mois-ci",
      previous: "Mois dernier",
      hourly: "Ventes du jour par heure",
